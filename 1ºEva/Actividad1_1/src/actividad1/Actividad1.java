...
public class Actividad1 {
    ...
    private static void insertarPersona(){
        ...
        System.out.println("Escribe cuantas casas tendrá?");
        int numcasas = Integer.parseInt(sc.nextLine());
        ArrayList <Vivienda> casas= new ArrayList <>();
        ...
        Persona nueva = new Persona(nombre,dni,edad,altura,peso,sexo,casas);
        nueva.generaDNI();
        odb.store(nueva);
    ...
    private static void verPersonas() {
        ...
        while(personas.hasNext()){
            ...
            for (int i = 0; i < p.getCasas().size(); i++){
                System.out.println(p.getCasas().get(i));
            }
        }
        odb.close();
    }
    ...
    private static void eliminarPersona() {
        ...
        while(personas.hasNext()){
             p = personas.next();
             odb.delete(p.getCasas());//elimina la casa
