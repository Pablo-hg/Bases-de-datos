...
public class EliminarEmpleado extends javax.swing.JFrame {
    ...
    private void jButtoneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtoneliminarActionPerformed
        if (jTextFieldasiento.getText().equals("")){
            ...
            controlador.ControladorMongo.EliminarEmpleado();
            controlador.Controlador.EliminarEmpleado();
            vista.EliminarEmpleado.jLabel3.setText("El empleado que se sentaba en el asiento " + this.jTextFieldasiento.getText() + " ha sido eliminado");
        }
